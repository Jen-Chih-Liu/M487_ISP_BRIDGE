...
#line 3 "..\\ISP_RS485_BUS.c"
#line 4 "..\\ISP_RS485_BUS.c"
#line 1 "..\\ISP_DRIVER.H"
...
void SendChar_ToRS485(uint8_t u8InChar)
{
    ...
    while((((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x35000UL)))->FIFOSTS & (0x1ul << (23)))>>(23))){};   
          ((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x35000UL)))->DAT = (u8InChar));
	  while((((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x35000UL)))->FIFOSTS & (0x1ul << (28))) >> (28))==0);   
...
ErrNo RS485_WRITE(io_handle_t handle, const void *buf, uint32 *len)
{
	...
	uint32 txlen=*len;
	pTxData = (uint8_t *)buf;
	(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(7))) + ((2)<<2))))=1;
	for (int i = 0; i < txlen; i++)
	     SendChar_ToRS485(pTxData[i]);		
    (*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(7))) + ((2)<<2))))=0;		 
	return 0;
}
...
ErrNo RS485_READ(io_handle_t handle, void *buf, uint32 *len)
{
	...
	for (int i = 0; i < rxlen; i++)
   {
		 while(1)
		 {
		 if((((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x35000UL)))->INTSTS & (0x1ul << (0)))>>(0)))
		 {
		 pRxData[i]=((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x35000UL)))->DAT);
			 break;
		 }
		 
		if(TIMER_GetIntFlag(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10000UL))))
			 {
...
ErrNo RS485_Config(void *priv)
{
    ...
    CLK_EnableModuleClock(((1UL<<30)|(3UL<<28) |(0x3UL<<25) |(30UL<<20) |(3UL<<18) |(0xFUL<<10) |(12UL<<5) |(21UL<<0)));


     
    CLK_SetModuleClock(((1UL<<30)|(3UL<<28) |(0x3UL<<25) |(30UL<<20) |(3UL<<18) |(0xFUL<<10) |(12UL<<5) |(21UL<<0)), (0x0UL << (30)), 0);

     
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPH_MFPL &= ~((0xful << (0)) | (0xful << (4)));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPH_MFPL |= ((0x04UL<<(0))) | ((0x04UL<<(4)));
     
		     
    UART_Open(((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x35000UL)), 115200);
	    CLK_EnableModuleClock(((1UL<<30)|(1UL<<28) |(0x7UL<<25) |(8UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(2UL<<0)));

     
    CLK_SetModuleClock(((1UL<<30)|(3UL<<28) |(0x3UL<<25) |(30UL<<20) |(3UL<<18) |(0xFUL<<10) |(12UL<<5) |(21UL<<0)), (0x0UL << (30)), (((1) - 1UL) << (8)));
    CLK_SetModuleClock(((1UL<<30)|(1UL<<28) |(0x7UL<<25) |(8UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(2UL<<0)), (0x0UL << (8)), 0);
	  
			     
    GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL)), (0x00000004UL), 0x1UL);
		(*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(7))) + ((2)<<2))))=0;
		return 0;
}
