...
uint8_t  g_buff[512] __attribute__((aligned(4)));
void initial_spi(void)
{
    ...
    CLK_EnableModuleClock(((0UL<<30)|(0x0UL<<28)|(0x0UL<<25)|(0x0UL<<20)|(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(14UL<<0)));
	
	
     
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPC_MFPL &= ~((0xful << (0)) | (0xful << (4)) | (0xful << (8)) |
                       (0xful << (12)) | (0xful << (16)) | (0xful << (20)));
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPC_MFPL |= (0x03UL<<(0)) | (0x03UL<<(4)) |
                     (0x03UL<<(8)) | (0x03UL<<(12)) |
                     (0x03UL<<(16)) | (0x03UL<<(20));
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->SMTEN |= (0x1ul << (2));

     
    ((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->SLEWCTL = (((GPIO_T *) (((uint32_t)0x40000000) + 0x04080UL))->SLEWCTL & 0xFFFFF000) |
                  (0x1<<(0)) | (0x1<<(2)) |
                  (0x1<<(4)) | (0x1<<(6)) |
                  (0x1<<(8)) | (0x1<<(10));
    ...
    do { ((volatile SPIM_T *) (0x40007000UL))->CTL1 = (((volatile SPIM_T *) (0x40007000UL))->CTL1 & (~(0xfffful << (16)))) | ((2) << (16)); } while (0);         

    do { (((volatile SPIM_T *) (0x40007000UL))->RXCLKDLY = (((volatile SPIM_T *) (0x40007000UL))->RXCLKDLY & (~(0x7ul << (16)))) | ((0) << (16))); } while (0);     
    (((volatile SPIM_T *) (0x40007000UL))->RXCLKDLY |= (0x1ul << (20)));;        

    do { ((volatile SPIM_T *) (0x40007000UL))->CTL2 = (((volatile SPIM_T *) (0x40007000UL))->CTL2 & ~(0x1ful << (24))) | (((8) & 0x1FUL) << (24)) | (0x1ul << (16)); } while (0);                 
