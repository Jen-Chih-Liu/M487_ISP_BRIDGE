...
#line 14 "..\\main_offline.c"
#line 1 "..\\SPI_FLASH_SPIM.H"
extern void initial_spi(void);
#line 15 "..\\main_offline.c"



io_handle_t  DEV_handle = 0;
...
#line 56 "..\\main_offline.c"
volatile uint32_t g_au32TMRINTCount;
void TMR1_IRQHandler(void)
{
    if(TIMER_GetIntFlag(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL))) == 1)
    {
...
void timer_1_init(void)
{
    ...
    CLK_SetModuleClock(((1UL<<30)|(1UL<<28) |(0x7UL<<25) |(12UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(3UL<<0)), (0x0UL << (8)), 0);
	
	 
    TIMER_Open(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL)), (1UL << (27)), 2);
...
int32_t main(void)
{
    ...
    SYS_Init();
   GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04040UL)), (0x00000020UL), 0x1UL);

	
	
	
	
	ret=io_open("CAN0", &DEV_handle);
	initial_spi();
	
	
	 check_error(101, "..\\main_offline.c", ret);
	 init_ISP_command();
	...
	check_error(111, "..\\main_offline.c", ret);
	printf("fw version:0x%x\n\r",fwversion);
	ret=GetDeviceID(&ISP_COMMAND,&devid);
	check_error(114, "..\\main_offline.c", ret);
	printf("device id:0x%x\n\r",devid);
	ret=GetConfig(&ISP_COMMAND,config);
	check_error(117, "..\\main_offline.c", ret);
	printf("config0: 0x%x\n\r", config[0]);
	printf("config1: 0x%x\n\r", config[1]);
	ret=GetFlashMode(&ISP_COMMAND,&flash_boot);
	check_error(121, "..\\main_offline.c", ret);
	printf("device id:0x%x\n\r",devid);
	if (flash_boot != 2)
	{
	...
	check_error(133, "..\\main_offline.c", ret);
