...
#line 3 "..\\ISP_CAN_BUS.C"
#line 4 "..\\ISP_CAN_BUS.C"
#line 1 "..\\ISP_DRIVER.H"
...
uint8_t i;
	...
	STR_CANMSG_T tMsg;
	CAN_T *tCAN;
	tCAN = (CAN_T *)((CAN_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x60000UL));
...
ErrNo CAN_Config(void *priv)
{
	...
	CLK_EnableModuleClock(((1UL<<30)|(0x0UL<<28)|(0x0UL<<25)|(0x0UL<<20)|(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(24UL<<0)));
	     
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL & ~((0xful << (16)) | (0xful << (20)))) |
                    ((0x0AUL<<(16)) | (0x0AUL<<(20)));
	CAN_Open(tCAN, 1000000, 0ul);
		for(int i=8;i<15;i++)
	CAN_SetRxMsgObj(tCAN, (i), 0ul, 0X100, (0UL));
	CAN_SetRxMsg(tCAN, (15), 0ul, 0X100); 
	
     
    GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x04000UL)), ((0x00000004UL) | (0x00000008UL)), 0x1UL);
    (*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(0))) + ((2)<<2)))) = 0;
    (*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(0))) + ((3)<<2)))) = 0;
	return 0;
}
