...
#line 3 "..\\ISP_UART_BUS.c"
#line 4 "..\\ISP_UART_BUS.c"
#line 1 "..\\ISP_DRIVER.H"
...
#line 5 "..\\ISP_UART_BUS.c"

void SendChar_ToUART0(uint8_t u8InChar)
{
    while((((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->FIFOSTS & (0x1ul << (23)))>>(23))){};   
          ((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->DAT = (u8InChar));
	  while((((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->FIFOSTS & (0x1ul << (28))) >> (28))==0);   
}
...
ErrNo ISP_UART_READ(io_handle_t handle, void *buf, uint32 *len)
{
  ...
  TIMER_Start(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10000UL)));
	for (int i = 0; i < rxlen; i++)
   {
		 while(1)
		 {
		 if((((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->INTSTS & (0x1ul << (0)))>>(0)))
		 {
		 pRxData[i]=((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->DAT);
			 break;
		 }
