...
#line 3 "..\\ISP_SPI_BUS.c"
#line 4 "..\\ISP_SPI_BUS.c"
#line 5 "..\\ISP_SPI_BUS.c"
#line 1 "..\\ISP_DRIVER.H"
...
ErrNo SPI_WRITE(io_handle_t handle, const void *buf, uint32 *len)
{
	...
	uint32 txlen=*len;
	pTxData = (uint8_t *)buf;
SPI_ClearRxFIFO(((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL)));
	SPI_ClearTxFIFO(((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL)));
	for (int i = 0; i<txlen; i++)
	{
		 
		((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL)))->TX = (pTxData[i]));
		CLK_SysTickDelay(300);
		 
		while (( ((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL)))->STATUS & (0x1ul << (0)))>>(0) ));
		while ((((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL)))->STATUS & (0x1ul << (16)))>>(16))==0);
		CLK_SysTickDelay(300);
	}
...
SPI_ClearRxFIFO(((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL)));
	...
	for (int i = 0; i<rxlen; i++)
	{
		...
		((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL)))->TX = (0xff));
		CLK_SysTickDelay(300);
		while (( ((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL)))->STATUS & (0x1ul << (0)))>>(0) ));
		while ((((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL)))->STATUS & (0x1ul << (16)))>>(16))==0);
		pRxData[i] = ((((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL)))->RX);
		CLK_SysTickDelay(300);
	}	
	CLK_SysTickDelay(5000);
	return 0;
...
ErrNo SPI_Config(void *priv)
{
	...
	CLK_SetModuleClock(((1UL<<30)|(2UL<<28) |(0x3UL<<25) |(4UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(13UL<<0)), (0x2UL << (4)), 0x0UL);


	 
	CLK_EnableModuleClock(((1UL<<30)|(2UL<<28) |(0x3UL<<25) |(4UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(13UL<<0)));

	 
	((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL |= (0x04UL<<(0)) | (0x04UL<<(4)) | (0x04UL<<(8)) | (0x04UL<<(12));

	 
	((GPIO_T *) (((uint32_t)0x40000000) + 0x04000UL))->SMTEN |= (0x1ul << (2));
   
     
	SPI_Open(((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL)), (0x0U), ((0x1ul << (2))), 8, 100000);
 
    SPI_EnableAutoSS(((SPI_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x21000UL)), ((0x1ul << (0))), (0x0U));
	return 0;
}
