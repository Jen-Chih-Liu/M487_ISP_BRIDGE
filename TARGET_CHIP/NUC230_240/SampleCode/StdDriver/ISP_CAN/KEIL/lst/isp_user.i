...
void EraseAP(uint32_t bAprom, unsigned int addr_start, unsigned int addr_end)
{
    ...
    if(bAprom == 1) {
        ...
        eraseLoop = 0x00000000UL;
    } else {
        eraseLoop = addr_start;
        erase_end = addr_end;
    }

    for(; eraseLoop < erase_end; eraseLoop += 0x200 ) {
    ...
    *size = 0;
    ...
    if(g_apromSize >= 0x20000) {
        ...
        if((uData&0x01) == 0) { 
            ...
            if(uData > g_apromSize || uData < 0x200)
                uData = g_apromSize;
    ...
    *((volatile unsigned int *)(response + 4)) = 0;
    ...
    if(lcmd == 0x000000A6) {
        ...
        *((volatile unsigned int *)(&((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->AIRCR)) = (0x05FA0000UL | 0x00000004UL);
        ...
        if(lcmd == 0x000000A3) { 
            EraseAP(0, 0, (g_apromSize < 0x20000)?0x20000:g_apromSize);
...
#line 241 "..\\ISP_USER.c"
    ...
    if((lcmd == 0x000000A0) || (lcmd == 0x000000C3)) {
        if(lcmd == 0x000000C3) {
            ...
            if(g_dataFlashSize) { 
                EraseAP(0, g_dataFlashAddr, g_dataFlashAddr + g_dataFlashSize);
            } else
                goto out;
        } else {
            StartAddress = 0;
