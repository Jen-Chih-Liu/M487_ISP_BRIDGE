...
#line 12 "..\\main.c"
#line 1 "..\\can_transfer.h"
extern __align(4) uint8_t  rcv_buf[64];
...
void SYS_Init(void)
{
    ...
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON = (0x00080000UL | (((4)-2)<<9) | ((26)-2) | 0x4000UL);
...
int32_t main(void)
{
    ...
    GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x4000) + 0x0100)), 0x00000008, 0x1UL);
   ...
   CAN_Open(tCAN, 1000000, 0);
		for(i=8;i<15;i++)
	CAN_SetRxMsgObj(tCAN, (i), 0, 0x102, 0);
	CAN_SetRxMsg(tCAN, (15), 0, 0x102);
